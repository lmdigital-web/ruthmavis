      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto flex min-h-[92vh] max-w-4xl flex-col items-center justify-center px-6 pt-32 pb-24 text-center sm:px-8">
          ...
          <div className="rise-in mt-10 flex flex-col items-center gap-4 [animation-delay:440ms] sm:flex-row">
            <Link
              to="/shop"
              className="group inline-flex items-center gap-2 rounded-full bg-burgundy px-8 py-3.5 font-sans text-sm tracking-wide text-burgundy-foreground shadow-[var(--shadow-soft)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-burgundy/90 border border-burgundy"
            >
